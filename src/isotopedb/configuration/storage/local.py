# src/isotopedb/configuration/storage/local.py
...
class LocalStorage:
    ...
    Requires the chromadb package: pip install isotopedb[chroma]
    ...
    def build_stores(self) -> tuple[VectorStore, ChunkStore, AtomStore, SourceRegistry]:
        ...
        vector_store = ChromaVectorStore(os.path.join(self.data_dir, "chroma"))
        ...
        return vector_store, chunk_store, atom_store, source_registry
